...
import com.vaha.justForFun.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void filterMessageTest() throws Exception {
        mockMvc.perform(get("/main").param("filter", "tag"))
                ...
                .andExpect(xpath("//div[@id='messages-list']/div[@data-id=3]").exists())
                .andExpect(xpath("//div[@id='messages-list']/div[@data-id=4]").exists());
    }
    ...
    public void addMessageToListTest() throws Exception {
        ...
        mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='messages-list']/div[@data-id=10]/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='messages-list']/div[@data-id=10]/div/i").string("#new one"));
    }
}